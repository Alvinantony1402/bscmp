...
contract('bloodbank', ([donor, bank, hosp, admin, bank2, hosp2]) => {
  let blood

  before(async () => { 
    blood = await bloodbank.deployed()
  }) 
  ...
  describe('Bloodbags', async () => {
    ...
    before(async () => {
      ...
      await blood.createBloodbag(donation, donor, "ALWIN", "1234567890","A+", expiry, "Mumbai", { from: bank2 })
      ...
      result = await blood.createBloodbag(donation, donor, "alwin", "1234567890", "A+", expiry, "Mumbai", { from: bank })
