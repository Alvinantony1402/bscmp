...
contract bloodbank{
    ...
    address payable public admin = address(0x52C38668E6B0c1a90781ffdfD802D7b21402813C);
    address payable public hospi = address(0x6EC8E21c49bDb57E2F3ff92E9408385dA6FEF773);
    ...
    constructor() public{
        name = "alwin";
        userCount ++;
        usertype[admin] = User(userCount, 14, "Admin", admin, "archana", '', '', "Mumbai");
        users[userCount] = User(userCount, 14, "Admin", admin, "archana", '', '', "Mumbai");
    }
