...
import './App.css';
import bloodbank from "../abis/bloodbank.json";
...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const networkData = bloodbank.networks[networkId]
    if(networkData) {
      const blood = web3.eth.Contract(bloodbank.abi, networkData.address)
      this.setState({ blood })
